...
/**
 * Validates and formats postal codes in Algeria.
 *
 * Algerian postal codes consist of 5 digits without separators or spaces.
 * The postal code system helps organize mail delivery across Algeria's
 ...
 */
final class DZHandler implements PostalCodeHandler
{
    /**
     * Validates an Algerian postal code.
     *
    ...
    /**
     * Formats an Algerian postal code to the standard format.
     *
     * Algerian postal codes do not require formatting as they are stored
    ...
    /**
     * Validates and formats an Algerian postal code.
     *
