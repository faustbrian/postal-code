...
/**
 * Validates and formats postal codes for New Zealand.
 *
 * New Zealand postal codes consist of exactly 4 digits without separators.
 * The system was introduced in June 2006 to improve mail sorting efficiency.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 * @see https://en.wikipedia.org/wiki/PostalCodes_in_New_Zealand
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class NZHandler implements PostalCodeHandler
{
    /**
     * Validates a postal code against New Zealand format requirements.
     *
    ...
    /**
     * Formats a postal code to New Zealand standard format.
     *
     ...
     * pattern matching. No formatting transformation is applied as New Zealand
