...
/**
 * Validates and formats postal codes in Malaysia.
 *
 * Malaysian postal codes are numeric, consisting of 5 digits without
 * separators. They follow a simple format with no additional validation
 * rules beyond the digit count requirement.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 * @see https://en.wikipedia.org/wiki/Postal_codes_in_Malaysia
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class MYHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code matches Malaysian format requirements.
     *
    ...
    /**
     * Formats the postal code according to Malaysian standards.
     *
     * Returns the postal code in its canonical format if valid, otherwise
     * returns the input unchanged. Malaysian postal codes do not require
     ...
     *
     * @return string Description of the Malaysian postal code format requirements
     */
     ...
     * 5 digits. Since Malaysian postal codes require no formatting, valid codes
