...
/**
 * Postal code handler for Cape Verde (ISO 3166-1 alpha-2: CV).
 *
 * Validates and formats postal codes according to Cape Verdean standards.
 ...
 */
final class CVHandler implements PostalCodeHandler
{
    /**
