...
/**
 * Validates and formats postal codes for Mexico (MX).
 *
 * Postal codes in Mexico consist of exactly 5 digits without any
 ...
 * @see https://en.wikipedia.org/wiki/Postal_codes_in_Mexico
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class MXHandler implements PostalCodeHandler
{
    /**
     * Validates whether a postal code matches the Mexico format.
     *
    ...
    /**
     * Formats a postal code to the standard Mexico format.
     *
    ...
    /**
     * Validates and formats the postal code according to Mexico rules.
     *
     * Ensures the postal code consists of exactly 5 digits. No formatting
     * changes are applied as Mexico postal codes have no separators.
     *
