...
/**
 * Validates and formats postal codes for Oman.
 *
 * Oman postal codes consist of exactly 3 digits without separators.
 * The postal code system is used exclusively for P.O. Box deliveries,
 * not for street addresses.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class OMHandler implements PostalCodeHandler
{
    /**
     * Validates a postal code against Oman format requirements.
     *
    ...
    /**
     * Formats a postal code to Oman standard format.
     *
     ...
     * pattern matching. No formatting transformation is applied as Oman
