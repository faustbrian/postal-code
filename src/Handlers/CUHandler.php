...
/**
 * Postal code handler for Cuba (ISO 3166-1 alpha-2: CU).
 *
 * Validates and formats postal codes according to Cuban standards.
 * Postal codes consist of exactly 5 numeric digits without separators.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class CUHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code matches the format requirements.
     *
     * Checks if the postal code conforms to the 5-digit format required
     * for Cuban addresses.
     *
     ...
     *
     * Returns the postal code if it matches the required 5-digit format,
