...
/**
 * Handles postal code validation and formatting for Guinea-Bissau.
 *
 * Guinea-Bissau uses a 4-digit numeric postal code system without separators.
 * All postal codes follow the format NNNN where N represents a digit.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class GWHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code conforms to Guinea-Bissau's format.
     *
    ...
    /**
     * Formats the postal code according to Guinea-Bissau's standard format.
     *
     * Since Guinea-Bissau postal codes have no separators, this returns the postal code
    ...
    /**
     * Validates and formats the postal code using the Guinea-Bissau pattern.
     *
     * Performs regex validation to ensure the postal code consists of exactly
     * 4 digits. Returns the formatted postal code on success, or null if invalid.
     *
