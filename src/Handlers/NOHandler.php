...
/**
 * Validates and formats postal codes in Norway.
 *
 * Norwegian postal codes are numeric, consisting of 4 digits without
 ...
 */
final class NOHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code matches Norwegian format requirements.
     *
    ...
    /**
     * Formats the postal code according to Norwegian standards.
     *
     * Returns the postal code in its canonical format if valid, otherwise
     * returns the input unchanged. Norwegian postal codes do not require
     ...
     *
     * @return string Description of the Norwegian postal code format requirements
     */
    public function hint(): string
    {
        return 'Norwegian Postal Codes are 4-digit codes.';
    }
     ...
     * 4 digits. Since Norwegian postal codes require no formatting, valid codes
