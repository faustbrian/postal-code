...
/**
 * Validates and formats postal codes for Mongolia (MN).
 *
 * Postal codes in Mongolia consist of exactly 5 digits without any
 ...
 */
final class MNHandler implements PostalCodeHandler
{
    /**
     * Validates whether a postal code matches the Mongolia format.
     *
    ...
    /**
     * Formats a postal code to the standard Mongolia format.
     *
    ...
    /**
     * Validates and formats the postal code according to Mongolia rules.
     *
     * Ensures the postal code consists of exactly 5 digits. No formatting
     * changes are applied as Mongolia postal codes have no separators.
     *
