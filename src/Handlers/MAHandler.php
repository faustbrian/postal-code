...
/**
 * Validates and formats postal codes for Morocco (MA).
 *
 * Postal codes in Morocco consist of exactly 5 digits without separators.
 * No country prefix is used in Morocco's postal code system.
 *
 ...
 */
final class MAHandler implements PostalCodeHandler
{
    /**
     * Validates whether the postal code matches Morocco's format.
     *
    ...
    /**
     * Formats the postal code according to Morocco's standards.
     *
    ...
    /**
     * Provides a human-readable hint about Morocco's postal code format.
     *
