...
/**
 * Validates and formats postal codes for Laos (LA).
 *
 * Laos uses a 5-digit numeric postal code system without separators.
 ...
 */
final class LAHandler implements PostalCodeHandler
{
    /**
     * Validates a postal code for Laos.
     *
    ...
    /**
     * Formats a postal code for Laos.
     *
     * Returns the postal code unchanged if valid, or the original
     * input if invalid. Laos postal codes require no formatting
     ...
     * Laos postal codes. Returns the postal code unchanged if valid,
