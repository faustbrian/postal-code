...
/**
 * Validates and formats postal codes for Panama.
 *
 * Panama postal codes consist of exactly 4 numeric digits without separators.
 * The postal code system was introduced to streamline mail delivery across
 * the country's provinces and districts.
 *
 ...
 */
final class PAHandler implements PostalCodeHandler
{
    /**
     * Validates a postal code against Panama format requirements.
     *
    ...
    /**
     * Formats a postal code to Panama standard format.
     *
    ...
    {
        return 'The postal codes consist of four numeric digits.';
    }
     ...
     * pattern matching. No formatting transformation is applied as Panama
