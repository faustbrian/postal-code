...
/**
 * Validates and formats postal codes for Paraguay.
 *
 * Paraguayan postal codes consist of 4 digits without any separator.
 * The postal code system covers all regions of Paraguay with unique
 * codes for different areas and postal zones.
 *
 ...
 */
final class PYHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code is valid for Paraguay.
     *
     * @param  string $postalCode The postal code to validate (4 digits)
    ...
    /**
     * Formats the postal code to the standard format for Paraguay.
     *
     * Since Paraguayan postal codes have no separator or special formatting,
     * valid codes are returned as-is. Invalid postal codes are returned unchanged.
     *
     * @param  string $postalCode The postal code to format (4 digits)
