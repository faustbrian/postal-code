...
/**
 * Validates and formats postal codes in Turkmenistan.
 *
 * Turkmenistan uses a 6-digit numeric postal code system without separators,
 * inherited from the Soviet postal system. The first three digits identify
 * the province or major city, while the remaining digits specify localities
 * and delivery zones.
 *
 ...
 */
final class TMHandler implements PostalCodeHandler
{
    /**
     * Validates whether a postal code matches Turkmenistan's format.
     *
    ...
    /**
     * Formats a postal code to Turkmenistan's standard format.
     *
