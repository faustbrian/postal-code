...
/**
 * Validates and formats postal codes in Nepal.
 *
 * Nepalese postal codes are numeric, consisting of 5 digits without
 * separators. They follow a simple format with no additional validation
 * rules beyond the digit count requirement.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes_in_Nepal
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class NPHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code matches Nepalese format requirements.
     *
    ...
    /**
     * Formats the postal code according to Nepalese standards.
     *
     * Returns the postal code in its canonical format if valid, otherwise
     * returns the input unchanged. Nepalese postal codes do not require
     ...
     *
     * @return string Description of the Nepalese postal code format requirements
     */
     ...
     * 5 digits. Since Nepalese postal codes require no formatting, valid codes
