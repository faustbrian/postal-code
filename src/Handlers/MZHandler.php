...
/**
 * Validates and formats postal codes in Mozambique.
 *
 * Mozambican postal codes are numeric, consisting of 4 digits without
 ...
 */
final class MZHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code matches Mozambican format requirements.
     *
    ...
    /**
     * Formats the postal code according to Mozambican standards.
     *
     * Returns the postal code in its canonical format if valid, otherwise
     * returns the input unchanged. Mozambican postal codes do not require
     ...
     *
     * @return string Description of the Mozambican postal code format requirements
     */
     ...
     * 4 digits. Since Mozambican postal codes require no formatting, valid codes
