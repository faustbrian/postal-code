...
/**
 * Validates and formats postal codes for Romania.
 *
 * Romanian postal codes consist of 6 digits without any separator.
 * The first digit represents the geographical region, while the
 * remaining digits identify specific localities and delivery areas.
 *
 ...
 */
final class ROHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code is valid for Romania.
     *
    ...
    /**
     * Formats the postal code to the standard format for Romania.
     *
     * Since Romanian postal codes have no separator or special formatting,
