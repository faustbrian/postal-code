...
/**
 * Validates and formats postal codes for Uruguay.
 *
 * Uruguay uses a 5-digit numeric postal code system without separators.
 * The postal code system helps identify specific delivery areas across
 * Uruguay's departments and municipalities.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class UYHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code matches Uruguay's format.
     *
    ...
    /**
     * Formats the postal code according to Uruguay's standard format.
     *
     * Uruguay postal codes require no formatting as they are already
     ...
     *
     * @return string Format hint for Uruguay postal codes
     */
