...
/**
 * Validates and formats postal codes for Pakistan.
 *
 * Pakistan postal codes consist of exactly 5 digits without separators.
 * The postal code system organizes mail delivery across the country's
 * provinces, districts, and local areas.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes_in_Pakistan
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class PKHandler implements PostalCodeHandler
{
    /**
     * Validates a postal code against Pakistan format requirements.
     *
    ...
    /**
     * Formats a postal code to Pakistan standard format.
     *
     ...
     *
     * Checks that the postal code consists of exactly 5 digits using regex
     * pattern matching. No formatting transformation is applied as Pakistan
