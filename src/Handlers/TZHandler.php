...
/**
 * Validates and formats postal codes for Tanzania.
 *
 * Tanzania uses a 5-digit numeric postal code system without separators.
 * The postal code system helps identify specific delivery areas across
 * Tanzania's regions and districts.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class TZHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code matches Tanzania's format.
     *
    ...
    /**
     * Formats the postal code according to Tanzania's standard format.
     *
     * Tanzania postal codes require no formatting as they are already
     ...
     *
     * @return string Format hint for Tanzania postal codes
     */
