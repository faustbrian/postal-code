...
/**
 * Handles postal code validation and formatting for Honduras.
 *
 * Honduras uses a 5-digit numeric postal code system without separators.
 ...
 */
final class HNHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code conforms to Honduras's format.
     *
    ...
    /**
     * Formats the postal code according to Honduras's standard format.
     *
     * Since Honduras postal codes have no separators, this returns the postal code
    ...
    /**
     * Validates and formats the postal code using the Honduras pattern.
     *
