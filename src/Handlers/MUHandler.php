...
/**
 * Validates and formats postal codes for Mauritius (MU).
 *
 * Postal codes in Mauritius consist of exactly 5 digits without any
 ...
 * @see https://en.wikipedia.org/wiki/Postal_codes_in_Mauritius
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class MUHandler implements PostalCodeHandler
{
    /**
     * Validates whether a postal code matches the Mauritius format.
     *
    ...
    /**
     * Formats a postal code to the standard Mauritius format.
     *
    ...
    /**
     * Validates and formats the postal code according to Mauritius rules.
     *
     * Ensures the postal code consists of exactly 5 digits. No formatting
     * changes are applied as Mauritius postal codes have no separators.
     *
