...
/**
 * Postal code handler for Switzerland (ISO 3166-1 alpha-2: CH).
 *
 * Validates and formats postal codes according to Swiss standards.
 * Postal codes consist of exactly 4 numeric digits without separators.
 * The system is also used in Liechtenstein.
 *
 ...
 */
final class CHHandler implements PostalCodeHandler
{
    /**
