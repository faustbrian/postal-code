...
/**
 * Validates and formats postal codes for Italy (IT).
 *
 * Italian postal codes (Codice di Avviamento Postale, CAP) consist of 5 digits
 * without any separator. The system was introduced in 1967 and covers all
 * Italian regions, with specific ranges assigned to different geographic areas.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 * @see https://en.wikipedia.org/wiki/Codice_di_avviamento_postale
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class ITHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code matches Italian format.
     *
    ...
    /**
     * Formats the postal code according to Italian standards.
     *
     * As Italian postal codes do not require formatting (they are already
     ...
     *
     * @return string Description of the Italian postal code format
     */
