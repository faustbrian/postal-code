...
/**
 * Validates and formats postal codes in Estonia.
 *
 * Estonian postal codes consist of 5 digits without separators or spaces.
 * The postal code system was introduced in 1991 and helps organize mail
 * delivery across Estonia's counties and municipalities.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class EEHandler implements PostalCodeHandler
{
    /**
     * Validates an Estonian postal code.
     *
    ...
    /**
     * Formats an Estonian postal code to the standard format.
     *
     * Estonian postal codes do not require formatting as they are stored
    ...
    /**
     * Validates and formats an Estonian postal code.
     *
