...
/**
 * Validates and formats postal codes in Trinidad and Tobago.
 *
 * Trinidad and Tobago uses a 6-digit numeric postal code system without
 * separators. The postal code system helps organize mail delivery across
 * the twin-island nation's various districts and localities.
 *
 ...
 */
final class TTHandler implements PostalCodeHandler
{
    /**
     * Validates whether a postal code matches Trinidad and Tobago's format.
     *
    ...
    /**
     * Formats a postal code to Trinidad and Tobago's standard format.
     *
