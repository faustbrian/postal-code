...
/**
 * Validates and formats postal codes for Cambodia (KH).
 *
 * Cambodian postal codes consist of 5 digits without any separator. The postal
 * code system was introduced in Cambodia to organize mail delivery and identify
 * different regions, provinces, and districts throughout the country.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class KHHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code matches Cambodian format.
     *
    ...
    /**
     * Formats the postal code according to Cambodian standards.
     *
     * As Cambodian postal codes do not require formatting (they are already
     ...
     *
     * @return string Description of the Cambodian postal code format
     */
