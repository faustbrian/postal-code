...
/**
 * Postal code handler for Indonesia (ID).
 *
 * Indonesia uses a 5-digit postal code system without separators.
 * Postal codes cannot start with 0, as all valid codes represent
 ...
 */
final class IDHandler implements PostalCodeHandler
{
    /**
     * Validates an Indonesian postal code.
     *
    ...
    /**
     * Formats an Indonesian postal code to its standard representation.
     *
     ...
     * and rejects codes starting with 0, which are not valid in Indonesia.
     *
    ...
    private function doFormat(string $postalCode): ?string
    {
        ...
        // Indonesian postal codes cannot start with 0
        if ($postalCode[0] === '0') {
            return null;
        }
