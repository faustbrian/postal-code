...
/**
 * Handles postal code validation and formatting for Guinea.
 *
 * Guinea uses a 3-digit numeric postal code system without separators.
 * All postal codes follow the format NNN where N represents a digit.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class GNHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code conforms to Guinea's format.
     *
    ...
    /**
     * Formats the postal code according to Guinea's standard format.
     *
     * Since Guinea postal codes have no separators, this returns the postal code
    ...
    /**
     * Validates and formats the postal code using the Guinea pattern.
     *
     * Performs regex validation to ensure the postal code consists of exactly
     * 3 digits. Returns the formatted postal code on success, or null if invalid.
     *
