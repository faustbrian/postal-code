...
/**
 * Validates and formats postal codes for Maldives (MV).
 *
 * Postal codes in the Maldives consist of exactly 5 digits without any
 ...
 */
final class MVHandler implements PostalCodeHandler
{
    /**
     * Validates whether a postal code matches the Maldives format.
     *
    ...
    /**
     * Formats a postal code to the standard Maldives format.
     *
    ...
    /**
     * Validates and formats the postal code according to Maldives rules.
     *
     * Ensures the postal code consists of exactly 5 digits. No formatting
     * changes are applied as Maldives postal codes have no separators.
     *
