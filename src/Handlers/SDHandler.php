...
/**
 * Validates and formats postal codes in Sudan.
 *
 * Sudanese postal codes consist of exactly 5 digits with no separator characters.
 *
 * @see https://en.wikipedia.org/wiki/List_of_postal_codes
 *
 * @author Brian Faust <brian@cline.sh>
 */
final class SDHandler implements PostalCodeHandler
{
    /**
     * Validates a Sudanese postal code.
     *
    ...
    /**
     * Formats a Sudanese postal code.
     *
     * Since Sudanese postal codes have no separator, this returns the code unchanged
     ...
     *
     * @return string Description of valid Sudanese postal code format
     */
    ...
    /**
     * Performs validation of Sudanese postal codes.
     *
