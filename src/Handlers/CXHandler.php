...
/**
 * Postal code handler for Christmas Island (ISO 3166-1 alpha-2: CX).
 *
 * Validates and formats postal codes according to Christmas Island standards.
 ...
 */
final class CXHandler implements PostalCodeHandler
{
    /**
     ...
     * for Christmas Island addresses.
     *
