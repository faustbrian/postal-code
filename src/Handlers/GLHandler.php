...
/**
 * Handles postal code validation and formatting for Greenland.
 *
 * Greenland uses a 4-digit numeric postal code system without separators.
 ...
 */
final class GLHandler implements PostalCodeHandler
{
    /**
     * Validates whether the provided postal code conforms to Greenland's format.
     *
    ...
    /**
     * Formats the postal code according to Greenland's standard format.
     *
     * Since Greenland postal codes have no separators, this returns the postal code
    ...
    /**
     * Validates and formats the postal code using the Greenland pattern.
     *
