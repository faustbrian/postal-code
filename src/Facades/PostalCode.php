...
{
    /**
     * Build facade mock by interface to support final concrete classes.
     *
     * Laravel's default implementation mocks the resolved root class, which
     * breaks when that class is final. By overriding this internal hook, we
     * keep default facade behavior while always mocking the interface.
     */
    #[Override()]
    protected static function createMock(): MockInterface
    {
        return Mockery::mock(PostalCodeManagerInterface::class);
    }
     ...
     *
     * @return string The fully qualified class name of the PostalCode manager
     */
    #[Override()]
